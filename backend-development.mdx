...
Use this when you want to check real-time traffic or when you need to make any changes to the production instance. Before making any changes on the production test them on a seperate EC2 instance and locally first.
