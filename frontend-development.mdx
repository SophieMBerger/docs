...
<Info>
  **Prerequisite** You should have Xcode correctly installed. And have been added to the Zeeno Apple Developer account.
</Info>
...
The iOS app is split up into two components: the target app and the keyboard extension.
 The target app is where the user completes onbaording and can adjust their keyboard experience. The keyboard extension is the main component the user will be interacting with when using Zeeno.
...
### App Store Review Zeeno Google Test Account
